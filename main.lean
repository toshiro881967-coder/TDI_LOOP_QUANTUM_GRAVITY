...
def main : IO Unit := do
  ...
  IO.println "--------------------------------------------------"
  IO.println "   LQC UNIMODULARE & INFLAZIONE (Gielen & Neves)  "
  IO.println "--------------------------------------------------"
  IO.println "Tempo Unimodulare (Volume Spaziotemporale): INTEGRATO"
  IO.println "Risoluzione della Singolarità (Big Bounce)  : PROOF VERIFIED"
  IO.println "Modelli Inflazionari (Starobinsky & α-attractor): MODELLATO"
  IO.println "--------------------------------------------------"
  ...
  IO.println "=================================================="
  IO.println "Caricamento completato: TdiProject (inclusi LQC Unimodulare, Inflazione & Poliedri Quantistici) verificato in Lean 4."
